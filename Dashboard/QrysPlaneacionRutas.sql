...
/*Actualizacion de Qrys para stored procedure y backend 06/02/2024, en este cambio se contemplan las guias en estatus 24 osea viaje local*/


set @IdRuta= 232;
/*Qry para planeacion de sucursales*/
select 
vg.referencia,
cp.sucursal_principal_id, 
sp.nombre as sucursal_principal, 
